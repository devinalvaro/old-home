...
function! s:sexp_mappings()
    ...
    nmap <buffer> ysf( <Plug>(sexp_round_head_wrap_list)
    xmap <buffer> ysf( <Plug>(sexp_round_head_wrap_list)
    nmap <buffer> ysf) <Plug>(sexp_round_tail_wrap_list)
    xmap <buffer> ysf) <Plug>(sexp_round_tail_wrap_list)
    nmap <buffer> ysf[ <Plug>(sexp_square_head_wrap_list)
    xmap <buffer> ysf[ <Plug>(sexp_square_head_wrap_list)
    nmap <buffer> ysf] <Plug>(sexp_square_tail_wrap_list)
    xmap <buffer> ysf] <Plug>(sexp_square_tail_wrap_list)
    nmap <buffer> ysf{ <Plug>(sexp_curly_head_wrap_list)
    xmap <buffer> ysf{ <Plug>(sexp_curly_head_wrap_list)
    nmap <buffer> ysf} <Plug>(sexp_curly_tail_wrap_list)
    xmap <buffer> ysf} <Plug>(sexp_curly_tail_wrap_list)
    nmap <buffer> dsf <Plug>(sexp_splice_list)

    nmap <buffer> yse(  <Plug>(sexp_round_head_wrap_element)
    xmap <buffer> yse(  <Plug>(sexp_round_head_wrap_element)
    nmap <buffer> yse)  <Plug>(sexp_round_tail_wrap_element)
    xmap <buffer> yse)  <Plug>(sexp_round_tail_wrap_element)
    nmap <buffer> yse[ <Plug>(sexp_square_head_wrap_element)
    xmap <buffer> yse[ <Plug>(sexp_square_head_wrap_element)
    nmap <buffer> yse] <Plug>(sexp_square_tail_wrap_element)
    xmap <buffer> yse] <Plug>(sexp_square_tail_wrap_element)
    nmap <buffer> yse{ <Plug>(sexp_curly_head_wrap_element)
    xmap <buffer> yse{ <Plug>(sexp_curly_head_wrap_element)
    nmap <buffer> yse} <Plug>(sexp_curly_tail_wrap_element)
    xmap <buffer> yse} <Plug>(sexp_curly_tail_wrap_element)
